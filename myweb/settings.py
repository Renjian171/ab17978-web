...
# 基因组数据所在目录（GENOME_DB、BLAST_DB、GFF3、FASTA 等数据文件都放在这里）
BACTERIA_DATA_DIR = r"C:\Users\ymh\Desktop\Ab17978\bacteria"
...
SECRET_KEY = "django-insecure-mrq=56^at&w60cdf2vr=8ggsqcm)4nkxo!9rkt2kol4@dtmowb"
...
DATABASES = {
    "default": {
        ...
        "OPTIONS": {
            "charset": "utf8mb4",  # 字符集（与数据库一致，避免乱码）
            "sql_mode": "STRICT_TRANS_TABLES",  # 严格模式（避免数据类型不匹配）
        },
    }
}
